...
public class WriteSymptomsDataInFile implements ISymptomsWriter {
     ...
     *
     * @param symptoms     correspond à la map où se trouve l'ensemble des symptomes et le nombre de leur occurence
     * @param listeOrdonne correspond à la liste ordonnée des symptomes
     */
